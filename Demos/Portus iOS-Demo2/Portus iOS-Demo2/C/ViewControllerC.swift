...
// MARK: - Routable
extension ViewControllerC: Routable {
    var entry: RoutingEntry { return RoutingEntry(identifier: .c, routable: self) }
}

// MARK: - Enterable
extension ViewControllerC: Enterable {
...
// MARK: - Leavable
extension ViewControllerC: Leavable {
