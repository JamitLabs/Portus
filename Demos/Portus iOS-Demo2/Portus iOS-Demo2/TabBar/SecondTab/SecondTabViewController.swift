...
extension RoutingIdentifier {
    static let secondTab = RoutingIdentifier(rawValue: "secondTab")
}
...
// MARK: - Routable
extension SecondTabViewController: Routable {
    var entry: RoutingEntry { return RoutingEntry(identifier: .secondTab, routable: self) }
}

// MARK: - Enterable
extension SecondTabViewController: Enterable {
